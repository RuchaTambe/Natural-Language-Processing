...
class NaiveBayesClassification:
    ...
    corpus_loc = ""
    read_parameter_loc = "nbmodel.txt"
    save_data_loc = "nboutput.txt"
    vocab_dict = dict()
    ...
    def __init__(self, input_file_path):
        self.corpus_loc = Path(input_file_path)
        self.parameter_reader = open(self.read_parameter_loc, "r")
        self.labelled_output_writer = open(self.save_data_loc, "w")
    ...
    def classification_engine(self):
        ...
        for each_email in self.corpus_loc.rglob('*.txt'):
