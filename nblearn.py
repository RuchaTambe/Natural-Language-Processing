...
class NaiveBayesModelTrain:
    ...
    def __init__(self, input_file_path):
        self.training_set_loc = Path(input_file_path)
        self.save_data = open(self.save_data_loc, "w")
    ...
    def data_acquisition(self):
        ...
        for each_email in self.training_set_loc.rglob('*.txt'):
